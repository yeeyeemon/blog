    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    {!! Form::text('title',$post->title, ['class'=>$errors->has('title') ? 'form-control is-invalid' : 'form-control']) !!}
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="hidden" class="image" name="hidden_image" value="{{$post->images}}"> 
                </div>
            </div>
        </div>
